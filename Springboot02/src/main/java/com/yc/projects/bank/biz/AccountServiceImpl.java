package com.yc.projects.bank.biz;


import com.yc.projects.bank.bean.Accounts;
import com.yc.projects.bank.bean.OpRecord;
import com.yc.projects.bank.bean.OpTypes;
import com.yc.projects.bank.dao.AccountDao;
import com.yc.projects.bank.dao.OpRecordDao;
...
public class AccountServiceImpl implements AccountService {
    ...
    public Accounts transfer(Accounts inaccount, Accounts outaccount, double money) {
        ...
        this.deposite(inaccount,money, OpTypes.transfer.getName(),uuid);
        Accounts a=this.withdraw(outaccount,money,OpTypes.transfer.getName(),uuid);
        return a;
    }
